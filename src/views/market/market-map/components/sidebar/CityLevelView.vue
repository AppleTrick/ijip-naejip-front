...
const formatPrice = (price: number) => {
  // price is in 10,000 KRW unit (e.g. 250000 = 25억)
  // User wants "3.7억" format
      ...
      >
        ...
        <div class="accordion-header">
          ...
          <div class="header-controls">
            <button class="control-btn go-to-btn" @click.stop="selectDistrict(stat)" title="지도로 이동">
...
.sub-graph-wrapper {
  ...
  padding: 0.5rem;
  border: 1px solid var(--color-gray-200);
  height: 120px; /* Explicit height for the wrapper */
}
