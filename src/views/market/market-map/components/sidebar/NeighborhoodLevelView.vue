...
const { selectApartment, goBack } = store
        ...
        <div class="accordion-header">
          <div class="header-content" @click="toggleAccordion(stat.id)">
            ...
            <div class="price-info">
              ...
              <span class="volume-badge" v-if="stat.volume">거래 {{ stat.volume }}건</span>
            </div>
          </div>
          
          <div class="header-controls">
            <button class="control-btn go-to-btn" @click.stop="selectApartment(stat.id)" title="상세 정보 보기">
